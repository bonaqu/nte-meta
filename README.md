...
- Автоимпорт персонажей и гайдов из проверяемых источников: NTE Wiki, GenshinBuilds, GameWith, Game8, BTVA, Dubbing Wiki, Icy Veins, Kaiden и официальный сайт как статус-источник. Каждая строка подтверждается редактором вручную.
...
Актуальная последняя миграция D1: `0014_unified_tierlist.sql`.
