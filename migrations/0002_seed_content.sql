...
('esper-zero', 'esper-zero', 'Нулевой эспер', 'Esper Zero', 'S', 'Flex', 'Flex', 'Космос', 'A', 'A', 30, 'assets/characters/Esper-Zero-Male.png', 'assets/characters/Esper-Zero-Female.png', 'Гибкий главный герой для закрытия недостающей роли в пачке.', 'Нулевой эспер ценен гибкостью и ранней доступностью.', '["free","flex","story"]', 'published', '1.0'),
